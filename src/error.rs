...
pub enum CoseError {
    ...
    /// Encryption could not be performed due to other errors in encryption.
    EncryptionErrorCustom(String),
}
...
impl fmt::Display for CoseError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            CoseError::EncryptionErrorCustom(e) => write!(f, "Encryption error: {}", e),
        }
    }
}
